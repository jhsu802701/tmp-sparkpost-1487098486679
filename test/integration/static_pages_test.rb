...
class StaticPagesTest < ActionDispatch::IntegrationTest
  test 'home page has expected content' do
    ...
    assert page.has_text?('Welcome to Temporary SparkPost App')
    assert page.has_css?('small', text: 'Temporary SparkPost App by Somebody')
  end
  ...
  test 'contact page has expected content' do
    ...
    assert page.has_text?('sparkpost@jasonhsu.com')
    assert page.has_css?('small', text: 'Temporary SparkPost App by Somebody')
  end
